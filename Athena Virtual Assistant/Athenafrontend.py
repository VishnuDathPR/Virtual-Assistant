...
assistant_name = tk.Label(window, text="ATHENA", font=("Arial Black", 30, "bold"), fg="#002244", bg="white")
assistant_name.place(x=840, y=60)

# Add the tagline
tagline = tk.Label(window, text="THE VIRTUAL ASSISTANT", font=("Times New Roman ", 15), fg="#002244", bg="white")
tagline.place(x=820, y=110)

# Add the GIF image
# Load the image
image_path = r"C:\Users\benso\Downloads\customer-support-flat-design_23-2148888766.jpg"
gif_image = Image.open(image_path)

# Resize the image
desired_width = 800
desired_height = 600
gif_image = gif_image.resize((desired_width, desired_height))
