...
def open_vscode():
    apath = r"C:\Users\benso\OneDrive\Desktop\Visual Studio Code.exe"
    os.startfile(apath)
#setting Alarm
def alarm(query):
...
def open_pictures():
    kpath = r"C:\Users\benso\OneDrive\Pictures"
    os.startfile(kpath)
...
def get_tired():
     ...
     if b==1:
         ...
         webbrowser.open("https://www.youtube.com/watch?v=pRbxlpvXw2s")   
     else:
         webbrowser.open("https://www.youtube.com/watch?v=_zNiTBmW-_o")   
